(function(){'use strict';var COMPILED=!0,goog=goog||{};goog.global=this;goog.isDef=function(a){return void 0!==a};goog.exportPath_=function(a,b,c){a=a.split('.');c=c||goog.global;a[0]in c||!c.execScript||c.execScript('var '+a[0]);for(var d;a.length&&(d=a.shift());)!a.length&&goog.isDef(b)?c[d]=b:c=c[d]?c[d]:c[d]={}};
...
goog.defineClass.applyProperties_=function(a,b){for(var c in b)Object.prototype.hasOwnProperty.call(b,c)&&(a[c]=b[c]);for(var d=0;d<goog.defineClass.OBJECT_PROTOTYPE_FIELDS_.length;d++)c=goog.defineClass.OBJECT_PROTOTYPE_FIELDS_[d],Object.prototype.hasOwnProperty.call(b,c)&&(a[c]=b[c])};goog.tagUnsealableClass=function(a){!COMPILED&&goog.defineClass.SEAL_CLASS_INSTANCES&&(a.prototype[goog.UNSEALABLE_CONSTRUCTOR_PROPERTY_]=!0)};goog.UNSEALABLE_CONSTRUCTOR_PROPERTY_='goog_defineClass_legacy_unsealable';var glue={detect:{}};glue.detect.decorateDom=function(a,b){goog.isArray(a)||(a=[a]);for(var c=document.documentElement,d=0,f;f=a[d];d++){var e=f.isSupported;f=f.FEATURE_ID;if(!e||!f)throw Error(glue.detect.ERROR.cannotDecorate);e()&&(b?c.setAttribute(glue.detect.getFeatureDataAttributeName_(f),''):c.className+=' '+glue.detect.getFeatureClassName_(f))}};glue.detect.getFeatureClassName_=function(a){return glue.detect.CLASSNAME_PREFIX+a};
glue.detect.getFeatureDataAttributeName_=function(a){return glue.detect.DATA_ATTRIBUTE_PREFIX+a};glue.detect.CLASSNAME_PREFIX='glue-';glue.detect.DATA_ATTRIBUTE_PREFIX='data-supports-';glue.detect.ERROR={cannotDecorate:'Cannot decorate for the specified feature.'};glue.detect.flexbox={};glue.detect.flexbox.PROPS='flexWrap WebkitFlexWrap MozFlexWrap OFlexWrap msFlexWrap boxDirection WebkitBoxDirection MozBoxDirection OBoxDirection msBoxDirection'.split(' ');glue.detect.flexbox.TEST_ELEMENT=document.documentElement.style;glue.detect.flexbox.isSupported=function(a){a=a||glue.detect.flexbox.TEST_ELEMENT;for(var b=glue.detect.flexbox.PROPS.slice(0);0<b.length&&!(b.shift()in a););return 0<b.length};glue.detect.flexbox.FEATURE_ID='flexbox';
goog.exportProperty(glue.detect.flexbox,'FEATURE_ID',glue.detect.flexbox.FEATURE_ID);var module$exports$assistant$detect={};glue.detect.decorateDom(glue.detect.flexbox);}).call(window);
